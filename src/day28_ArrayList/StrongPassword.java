...
public class StrongPassword {
    ...
    public static void main(String[] args) {
       ...
       boolean strongPassword = isStrongPassword(password);
        ...
        System.out.println("isStrongPassword = " + strongPassword);

        String password2 = "cydeo1990@";

        boolean is_a_strong_password = isStrongPassword(password2);

        System.out.println("is_a_strong_password = " + is_a_strong_password);

...
public class WarmupTasks {
    ...
    public static void main(String[] args) {
        ...
        list2.addAll(Arrays.asList(1,0,2,3,0,4,0));
...
2. write a program that can move all the zeros to the last indexs of Arraylist.

3. Write a program that can extract the special characters, digits and letters from a string and stores them into separate ArrayList.
 */
